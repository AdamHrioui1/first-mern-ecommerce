  ...
  return (
    <div>
        <div className="privacy_policy_container">
            ...
            <li>
            <p><strong>Website</strong> refers to BowWoow, accessible from <Link to="https://www.bowwoow.herokuapp.com" rel="external nofollow noopener" target="_blank">https://www.bowwoow.herokuapp.com</Link></p>
            </li>
            <li>
